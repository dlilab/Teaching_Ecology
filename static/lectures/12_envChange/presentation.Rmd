...
output:
  xaringan::moon_reader:
    css: ["default", "default-fonts", "../style.css", "hygge"]
    lib_dir: libs
    nature:
...
---
background-image: url('figs/invasion.png')
...
---
background-image: url('figs/co2_trend_mlo.png')
background-position: 50% 60%
background-size: contain
class: center, top

---
background-image: url('figs/co2_data_mlo.png')
background-position: 50% 60%
background-size: contain
class: center, top

---
background-image: url('figs/respiration.jpg')
background-position: 50% 60%
background-size: contain
class: center, top
...
---
background-image: url('figs/sea_level.webp')
background-position: 50% 50%
...
.pull-right[
![](figs/Sea_level_history_and_projections.png)

.center[![:scale 70%](figs/Sea-level-rise-vulnerability.jpg.webp)]
]
...
.center[![:scale 60%](figs/hurricane.png)]
...
.center[![:scale 60%](figs/fires-us-cumulative-burned-area-2020-wri.gif)]
...
.center[![:scale 60%](figs/fires-emissions-climate-feedback-loop-wri.png)]
...
---
background-image: url('figs/ocean_acid2.png')
background-position: 50% 50%
background-size: cover
class: center, top
...
---
background-image: url('figs/mississippi-river-watershed-map-rs.jpeg')
background-position: 50% 50%
background-size: cover
class: center, top

---
background-image: url('figs/o2.png')
background-position: 50% 50%
background-size: cover
class: center, top
...
![](figs/spreading_deadzone.png)

.right[Diaz and Rosenberg, Science, 2008]
---
...
.font200[Plants and animals are flowering, mating, and migrating earlier (Root et al. 2001)]
...
background-image: url('../10_networks/figs/econet.jpeg')
background-position: 50% 50%
background-size: contain
class: left, top
